...
const Banner = () => {
  return (
    <div className="flex min-h-[500px] w-full items-center justify-between gap-[10px] py-[40px]">
      {/* Text Section */}
      <div className="w-full lg:w-3/5">
        ...
        <h1 className="font-secondary mb-[16px] max-w-[500px] text-[32px] leading-tight font-semibold text-white sm:text-[36px] md:text-[46px]">
          Join our Digital Skill Development Program today and be part of a
      ...
      {/* Image Section */}
      <div className="hidden w-2/5 shrink-0 self-start lg:block">
        <img
          src="/heroImages/programs-banner-2.png"
