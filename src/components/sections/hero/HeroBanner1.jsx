  ...
  return (
    <div className="flex min-h-[500px] w-full items-center justify-center gap-[10px] py-[40px]">
      ...
      <div className="w-full lg:w-3/5">
        ...
        <h1 className="font-secondary mb-[16px] text-[32px] leading-tight font-semibold text-white sm:text-[36px] md:text-[46px]">
        ...
        <p className="mb-[24px] text-base text-white opacity-90 md:text-lg">
