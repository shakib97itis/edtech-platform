  ...
  return (
    ...
    >
      <div className="group relative cursor-pointer">
        <div
          className={`group-hover:border-primary-700 absolute left-[250px] h-[520px] w-full max-w-[340px] rounded-[30px] border border-transparent bg-white transition-all duration-500`}
        ></div>
      ...
      <div className="absolute top-0 left-[346px] h-[163.71px] w-[158.23px]">
        <img
          ...
          src="/public/howDoesItWorksImages/number1.png"
        />
      </div>
      <div
        className={`bg-primary-700 absolute top-[73.5%] left-[384px] h-[11px] w-[81px] rounded-[30px]`}
      ></div>
    </div>
  );
};
